 ...
 */
public class MooreRecyclerViewAdapter extends RecyclerView.Adapter<MooreRecyclerViewAdapter.ViewHolder>{
    List<Cll> mCllList;
    OnCllTouchListener mOnCllTouchListener;
    public MooreRecyclerViewAdapter(Context context,List<Cll> cllList) {
        mCllList = cllList;
